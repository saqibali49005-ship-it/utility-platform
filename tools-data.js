...
window.UTILITY_TOOLS = [
  {slug:"case-converter",title:"Case Converter Online",href:"case-converter.html",category:"digital-developer",description:"Convert text to uppercase, lowercase, title, sentence, camelCase, PascalCase, snake_case, kebab-case and CONSTANT_CASE.",addedOrder:13,keywords:["case converter","uppercase","lowercase","title case","sentence case","camelCase","PascalCase","snake case","kebab case","constant case"]},
